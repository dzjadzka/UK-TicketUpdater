# Archived: Frontend Setup and Usage (Unimplemented)

> Status: This document captured a proposed React-based UI that was never implemented. The repository only contains a Vite/React scaffold; the pages and flows described below do not exist in the current codebase and are preserved here for historical context.

## Overview

This archived note outlined a prospective web interface for managing ticket downloads, credentials, device profiles, and viewing history. It should not be used as setup guidance for the present project state.
...
These steps described how the proposed UI might have been run during development. They do not reflect a functioning frontend in the repository today.
...
The lists below capture the originally envisioned UI flows. They remain unbuilt and are retained solely for reference.
